...
let allSpades   = List.filter (fun a -> getValue a = Color.Spade) all
let allHearts   = List.filter (fun a -> getValue a = Color.Heart) all
let allDiamonds = List.filter (fun a -> getValue a = Color.Diamond) all
let allClubs    = List.filter (fun a -> getValue a = Color.Club) all
